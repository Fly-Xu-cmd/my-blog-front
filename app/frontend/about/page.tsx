  ...
  return (
    <div className="w-full py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        {/* 个人介绍卡片 */}
        <div className="bg-white border border-gray-100 rounded-2xl shadow-sm p-8 md:p-10 dark:bg-white/[0.04] dark:border-white/10 dark:backdrop-blur-xl">
          <div className="max-w-none">
            ...
            <p className="text-gray-700 dark:text-white/70 leading-relaxed mb-6">
              ...
              <span className="bg-gray-100 dark:bg-white/10 px-2 py-0.5 rounded font-mono text-sm">
                “Hello, World!”
              </span>
              程序开始，一步步深入到更为复杂的项目开发中，这个过程虽然充满了挑战，但每一次成功解决问题后的那种成就感，让我越发着迷于技术的世界，也更加坚定了在这条道路上走下去的决心。
            </p>

            <div className="my-8 p-6 rounded-xl border border-cyan-100 dark:border-cyan-400/20 bg-gradient-to-br from-cyan-50 to-violet-50 dark:from-cyan-400/10 dark:to-violet-400/10">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3 flex items-center gap-2">
                <span className="w-1 h-5 rounded-full bg-gradient-to-b from-cyan-500 to-violet-500" />
                技术专长
              </h3>
            ...
            <p className="text-gray-700 dark:text-white/70 leading-relaxed mb-6">
              ...
              <span className="bg-amber-50 text-amber-700 dark:bg-amber-400/10 dark:text-amber-300 px-2 py-0.5 rounded">
                “坑”
              </span>
            ...
            <p className="text-gray-700 dark:text-white/70 leading-relaxed italic font-medium text-center">
